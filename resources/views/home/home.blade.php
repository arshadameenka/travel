...
<x-home.header-scripts/>
   <body class="home">
      <div id="siteLoader" class="site-loader">
         <div class="preloader-content">
            <img src="{{ Vite::asset('resources/assets/images/loader1.gif')}}" alt="">
         </div>
      </div>
      <div id="page" class="full-page">
                     ...
                     <div class="col-lg-8 d-none d-lg-block">
                        <div class="header-contact-info">
                           <ul>
                              ...
                              <li>
                                 <a href=""><i class="fas fa-envelope"></i> <span class="__cf_email__" >taj@gmail.com</span></a>
                              </li>
                              <li>
            ...
            <div class="bottom-header">
               <div class="container d-flex justify-content-between align-items-center">
                  <div class="site-identity">
                     <h1 class="site-title">
                        <a href="index.html">
                           <img class="white-logo" src="{{ Vite::asset('resources/assets/images/travele-logo.png')}}" alt="logo">
                           <img class="black-logo" src="{{ Vite::asset('resources/assets/images/travele-logo1.png')}}" alt="logo">
                        </a>
                     </h1>
                  </div>
                  ...
                  <div class="header-btn">
                     <a href="{{route('login')}}" class="button-primary">BOOK NOW</a>
                  </div>
               </div>
            </div>
         ...
         <main id="content" class="site-main">
            ...
            <section class="home-slider-section ">
               <div class="home-slider">
                  <div class="home-banner-items">
                     <div class="banner-inner-wrap" style="background-image: url({{ Vite::asset('resources/assets/images/slider-banner-1.jpg')}});"></div>
                  ...
                  <div class="home-banner-items">
                     <div class="banner-inner-wrap" style="background-image: url({{ Vite::asset('resources/assets/images/slider-banner-2.jpg')}});"></div>
                        <div class="banner-content-wrap">
                           <div class="container">
                              <div class="banner-content text-center">
                        ...
                        <div class="col-lg-7">
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{ Vite::asset('resources/assets/images/img1.jpg')}}" alt="">
                                    </figure>
                              ...
                              <div class="col-sm-6">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{ Vite::asset('resources/assets/images/img2.jpg')}}" alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                                       <a href="#">NORWAY</a>
                                    </div>
                        ...
                        <div class="col-lg-5">
                           <div class="row">
                              <div class="col-md-6 col-xl-12">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{ Vite::asset('resources/assets/images/img3.jpg')}}" alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                              ...
                              <div class="col-md-6 col-xl-12">
                                 <div class="desti-item overlay-desti-item">
                                    <figure class="desti-image">
                                       <img src="{{ Vite::asset('resources/assets/images/img4.jpg')}}" alt="">
                                    </figure>
                                    <div class="meta-cat bg-meta-cat">
                                       <a href="#">SINGAPORE</a>
                                    </div>
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ Vite::asset('resources/assets/images/img5.jpg')}}" alt="">
                                 </a>
                              </figure>
                              ...
                              <div class="package-content-wrap">
                                 ...
                                 <div class="package-content">
                                    ...
                                    <div class="btn-wrap">
                                       <a href="{{route('login')}}" class="button-text width-6">Book Now<i class="fas fa-arrow-right"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ Vite::asset('resources/assets/images/img6.jpg')}}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ Vite::asset('resources/assets/images/img7.jpg')}}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
            ...
            <section class="callback-section">
               <div class="container">
                  <div class="row no-gutters align-items-center">
                     <div class="col-lg-5">
                        <div class="callback-img" style="background-image: url({{ Vite::asset('resources/assets/images/img8.jpg')}});">
                        ...
                        <div class="callback-inner">
                           ...
                           <div class="callback-counter-wrap">
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{ Vite::asset('resources/assets/images/icon1.png')}}" alt="">
                                 </div>
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{ Vite::asset('resources/assets/images/icon2.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{ Vite::asset('resources/assets/images/icon3.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                              ...
                              <div class="counter-item">
                                 <div class="counter-icon">
                                   <img src="{{ Vite::asset('resources/assets/images/icon4.png')}}" alt="">
                                 </div>
                                 <div class="counter-content">
                                    <span class="counter-no">
                           ...
                           <div class="support-area">
                              <div class="support-icon">
                                 <img src="{{ Vite::asset('resources/assets/images/icon5.png')}}" alt="">
                              </div>
                  ...
                  <div class="activity-inner row">
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon6.png')}}" alt="">
                              </a>
                           </div>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon10.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon9.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon8.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon7.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                     ...
                     <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="activity-item">
                           <div class="activity-icon">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/icon11.png')}}" alt="">
                              </a>
                           </div>
                           <div class="activity-content">
                              <h4>
                  ...
                  <div class="special-inner">
                     <div class="row">
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img9.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>20%</strong>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img10.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>15%</strong>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="special-item">
                              <figure class="special-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img11.jpg')}}" alt="">
                              </figure>
                              <div class="badge-dis">
                                 <span>
                                    <strong>15%</strong>
                  ...
                  <div class="row">
                     <div class="col-lg-5">
                        ...
                        <figure class="gallery-img">
                           <img src="{{ Vite::asset('resources/assets/images/img12.jpg')}}" alt="">
                        </figure>
                     </div>
                     <div class="col-lg-7">
                        <div class="row">
                           <div class="col-sm-6">
                              <figure class="gallery-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img13.jpg')}}" alt="">
                              </figure>
                           </div>
                           <div class="col-sm-6">
                              <figure class="gallery-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img14.jpg')}}" alt="">
                              </figure>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-12">
                              <figure class="gallery-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img15.jpg')}}" alt="">
                              </figure>
                           </div>
                        </div>
                     </div>
               ...
               <div class="container">
                  <div class="client-wrap client-slider secondary-bg">
                     <div class="client-item">
                        <figure>
                           <img src="{{ Vite::asset('resources/assets/images/logo1.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{ Vite::asset('resources/assets/images/logo2.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{ Vite::asset('resources/assets/images/logo3.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{ Vite::asset('resources/assets/images/logo4.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
                           <img src="{{ Vite::asset('resources/assets/images/logo5.png')}}" alt="">
                        </figure>
                     </div>
                     <div class="client-item">
                        <figure>
            ...
            <section class="subscribe-section" style="background-image: url({{ Vite::asset('resources/assets/images/img16.jpg')}});">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
                        <div class="section-heading section-heading-white">
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/img17.jpg')}}" alt="">
                              </a>
                           </figure>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/img18.jpg')}}" alt="">
                              </a>
                           </figure>
                           <div class="entry-content">
                              <h3>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           <figure class="feature-image">
                              <a href="#">
                                 <img src="{{ Vite::asset('resources/assets/images/img19.jpg')}}" alt="">
                              </a>
                           </figure>
                           <div class="entry-content">
                              <h3>
            ...
            <div class="testimonial-section" style="background-image: url({{ Vite::asset('resources/assets/images/img23.jpg')}});">
               <div class="container">
                  <div class="row">
                        ...
                        <div class="testimonial-inner testimonial-slider">
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img20.jpg')}}" alt="">
                              </figure>
                           ...
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img21.jpg')}}" alt="">
                              </figure>
                              <div class="testimonial-content">
                                 <p>" Dolorum aenean dolorem minima! Voluptatum? Corporis condimentum ac primis fusce, atque! Vivamus. Non cupiditate natus excepturi, quod quo, aute facere? Deserunt aliquip, egestas ipsum, eu.Dolorum aenean dolorem minima!? Corporis condi mentum acpri! "</p>
                                 <cite>
                           ...
                           <div class="testimonial-item text-center">
                              <figure class="testimonial-img">
                                 <img src="{{ Vite::asset('resources/assets/images/img22.jpg')}}" alt="">
                              </figure>
                              <div class="testimonial-content">
                                 <p>" Dolorum aenean dolorem minima! Voluptatum? Corporis condimentum ac primis fusce, atque! Vivamus. Non cupiditate natus excepturi, quod quo, aute facere? Deserunt aliquip, egestas ipsum, eu.Dolorum aenean dolorem minima!? Corporis condi mentum acpri! "</p>
                                 <cite>
            ...
            <section class="contact-section">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="contact-img" style="background-image: url({{ Vite::asset('resources/assets/images/img24.jpg')}});">
                        </div>
                     </div>
                     <div class="col-lg-8">
                        <div class="contact-details-wrap">
                           <div class="row">
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                       <img src="{{ Vite::asset('resources/assets/images/icon12.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
                                          <a href="#"><span class="__cf_email__" data-cfemail="c1b2b4b1b1aeb3b581a6aca0a8adefa2aeac">[email&#160;protected]</span></a>
                                       </li>
                                       <li>
                                          <a href="#"><span class="__cf_email__" data-cfemail="3f565159507f5b50525e5651115c5052">[email&#160;protected]</span></a>
                                       </li>
                                       <li>
                                          <a href="#"><span class="__cf_email__" data-cfemail="305e515d5570535f5d40515e491e535f5d">[email&#160;protected]</span></a>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                       <img src="{{ Vite::asset('resources/assets/images/icon13.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
                              ...
                              <div class="col-sm-4">
                                 <div class="contact-details">
                                    <div class="contact-icon">
                                       <img src="{{ Vite::asset('resources/assets/images/icon14.png')}}" alt="">
                                    </div>
                                    <ul>
                                       <li>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-md-6">
                        <aside class="widget widget_text">
                           ...
                           <div class="award-img">
                              <a href="#"><img src="{{ Vite::asset('resources/assets/images/logo6.png')}}" alt=""></a>
                              <a href="#"><img src="{{ Vite::asset('resources/assets/images/logo2.png')}}" alt=""></a>
                           </div>
                        </aside>
                     </div>
                     <div class="col-lg-3 col-md-6">
                              ...
                              <ul>
                                 ...
                                 <li>
                                    <a href="#">
                                       ...
                                       <span class="__cf_email__" data-cfemail="c8aba7a5b8a9a6b188aca7a5a9a1a6e6aba7a5">[email&#160;protected]</span>
                                    </a>
                                 </li>
                                 <li>
                                    <i class="fas fa-map-marker-alt"></i>
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-2 text-center">
                        <div class="footer-logo">
                           <a href="#"><img src="{{ Vite::asset('resources/assets/images/travele-logo.png')}}" alt=""></a>
                        </div>
                     </div>
                     <div class="col-md-5">
